        ...
        <div className="flex items-center justify-between h-20 gap-4">
          ...
          <div className="flex items-center space-x-3">
            {isAuthenticated ? (
                ...
                >
                  ...
                  <div className="text-left hidden sm:block">
                    ...
                    <p className="text-[10px] text-slate-400">
                      Active Vault ({patientCount} Network Records)
                    </p>
                  </div>
              ...
              <>
                {/* Logged Out State Prompt & Login Button */}
                <button
                  ...
                  title="Log in to unlock your medical records"
                >
                  <Lock className="w-3.5 h-3.5 text-cyan-300 group-hover:scale-110 transition-transform" />
                  <span>Log In to Vault</span>
                </button>

                <button
                  onClick={onOpenPatientSwitcher}
                  className="hidden sm:flex items-center space-x-1.5 px-3 py-2 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-300 text-xs font-semibold border border-slate-700 transition-all"
                >
