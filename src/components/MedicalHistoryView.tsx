    ...
    <div className="space-y-8 max-w-6xl mx-auto pb-12">
      ...
      <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/80 shadow-sm space-y-6">
        ...
        <div className="flex items-center space-x-2 border-b border-slate-100 overflow-x-auto pb-2 scrollbar-none">
          {[
            { id: "diseases", label: "Diseases & Conditions", icon: Activity, count: history.diseases.length },
            { id: "surgeries", label: "Surgeries & Procedures", icon: Scissors, count: history.surgeries.length },
            { id: "vaccinations", label: "Vaccinations", icon: Syringe, count: history.vaccinations.length },
            { id: "allergies", label: "Allergies & Sensitivities", icon: AlertOctagon, count: history.allergies.length },
            { id: "family", label: "Family History", icon: Users, count: history.familyHistory.length },
            { id: "chronic", label: "Chronic Illnesses", icon: HeartPulse, count: history.chronicIllnesses.length },
      ...
      {activeTab === "chronic" && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {history.chronicIllnesses.map((chr) => (
